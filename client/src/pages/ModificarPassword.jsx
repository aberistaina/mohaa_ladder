...
return (
    <>
        <div className="w-full max-w-md p-6 border border-slate-500 rounded mb-10 md:mb-0">
                    ...
                    <button
                        className="mb-10 px-4 py-4 mx-2 bg-blue-600 text-white font-bold rounded-lg shadow-md hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-red-300 transition-all duration-300 text-xl"
                    >
