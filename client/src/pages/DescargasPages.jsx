...
export const DescargasPages = () => {
  return (
    <>
        ...
        <div className="bg-[url('public/background2.svg')] bg-cover bg-center w-full min-h-screen flex flex-wrap justify-around items-center">
    <div className="flex flex-col items-center justify-center mb-4 sm:w-full md:w-1/3 lg:w-1/3">
        <img src="logoJuego.png" alt="Logo Juego" className="max-w-full h-auto mb-4" />
