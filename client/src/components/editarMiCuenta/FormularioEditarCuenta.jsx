        ...
        <>
            <form className="space-y-4 w-2/4" onSubmit={(e) => handleSubmit(e)}>
                ...
                <div className="flex justify-center">
                    <button className="px-2 py-1 mx-2  bg-green-600 text-white font-bold rounded-lg shadow-md hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-red-300 transition duration-300">
